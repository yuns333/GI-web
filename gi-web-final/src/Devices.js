        ...
        console.log("-----------data::",that.props.userId, that.props.projectName, that.props.period)
          ...
          .then(function (response) {
            var temp = response.data;
                        ...
                        var svg3 = d3.select("#devices_breakdown")
                        .append('svg')
                        .attr('class', 'pie')
                        .attr('width', width)
                        .attr('height', height);
                        ...
                        var legendGroup3 = d3.select('#devices_breakdown svg').append("g")
                            
                            legendGroup3.selectAll('mydot')
                            .data(data)
                            .enter()
                            .append('circle')
                            .attr('cx', function(d) {
                            ...
                            legendGroup3.selectAll('mylabel')
                            .data(data)
                            .enter()
                            .append('text')
                            .attr('x', 340)
